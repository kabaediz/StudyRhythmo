...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNoteEntity = new EntityInsertionAdapter<NoteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notes` (`id`,`courseId`,`title`,`content`,`createdAt`,`updatedAt`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfNoteEntity = new EntityDeletionOrUpdateAdapter<NoteEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `notes` SET `id` = ?,`courseId` = ?,`title` = ?,`content` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `id` = ?";
      }
      ...
      public List<NoteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new NoteEntity(_tmpId,_tmpCourseId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<NoteEntity>> getNotesByCourse(final long courseId) {
    final String _sql = "SELECT * FROM notes WHERE courseId = ? ORDER BY updatedAt DESC";
      ...
      public NoteEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new NoteEntity(_tmpId,_tmpCourseId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
